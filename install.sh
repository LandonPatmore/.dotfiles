...
# Step 6: Download and install Powerlevel10K theme
echo "Step 6: Cloning Powerlevel10K repository..."
git clone $POWERLEVEL10K_URL $OH_MY_ZSH_DIR/custom/themes/powerlevel10k

# Step 7: Create a symbolic link for .zshenv from dotfiles to home directory
